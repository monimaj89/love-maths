...
function runGame(gameType) {
    // puste okienko po kadej odpowiedzi
    document.getElementById('answer-box').value = "";

    // kursos od razu po załadowaniu strony
...
function checkAnswer() {
    // .value not innerText because it is input
...
function calculateCorrectAnswer() {
    ...
    // inner.Text wyświetli wynik jako tekst.
    ...
    if (operator === "+") {
        ...
        throw `Unimplemented operator ${operator}. Abroting!`;
    }
